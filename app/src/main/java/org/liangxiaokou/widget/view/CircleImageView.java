...
public class CircleImageView extends ImageView {
    ...
    private RedTipImageView.TipType mTipType = RedTipImageView.TipType.RED_TIP_INVISIBLE;
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        //拓展显示数字1
        tipVisibility = a.getInt(R.styleable.CircleImageView_civ_redTipsVisibility, 0);
        a.recycle();
        mContext = context;
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (tipVisibility == RedTipImageView.TipType.RED_TIP_VISIBLE.getCode() || mTipType == RedTipImageView.TipType.RED_TIP_VISIBLE) {
            int width = getWidth();
